                ...
                <div class="modal-body">
                    ...
                    <div class="form-step active">
                        ...
                        <input type="hidden" id="cita_id" value="<?= $cita->id ?>">
                            <div class="car-impact-container position-relative mx-auto col-md-7" style="margin-left: 30px;">
                                <img src="http://localhost/cms-web-projects-alvaro/cms/source/assets_app/images/taller/golpe/cocheGolpe.jpg" alt="Esquema coche" class="img-fluid">

                                <!-- Zona de impacto con checkbox e input file -->
                            ...
                            <div id="contenedorInputsImpacto_Arriba" class="col-md-3 pull-right">
                                <h5>Por arriba</h5>
                    ...
                    <div class="form-step">
                        ...
                        <div class="row" style="margin-bottom: 20px;">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" name="kilometros" id="kilometros" placeholder="Ej: 152000">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <canvas id="firmaCanvas" width="825" height="250" style="border:1px solid #ccc;" class="mb-3"></canvas>
...
<?php $this->load->view('include/modal_confirmacion_img'); ?>
