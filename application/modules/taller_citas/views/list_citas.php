...
<ul class="panel-controls">
	<?php if($acceso[1]==1): ?>
		<li>
			<button type="button" class="btn btn-primary activar_modal_add" data-toggle="modal" data-target="#modal_form" title="Crear cita" style="border-radius: 100%; width: 30px; height: 30px; display: flex; align-items: center; justify-content: center;">
