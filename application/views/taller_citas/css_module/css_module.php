...
<style>
    ...
    #contenedorInputsImpacto .input-group {
        flex: 1 1 45%;
        min-width: 300px;
        /* Asegura que no sean demasiado pequeños en pantallas pequeñas */
    }
    ...
    @media (max-width: 576px) {
        ...
        .tabla_citas th:nth-child(9),
        .tabla_citas td:nth-child(9),
        .tabla_citas th:nth-child(3),
        .tabla_citas td:nth-child(3) {
            display: none;
        }
    }
    ...
    @media (max-width: 767px) {
        ...
        /* Para centrar los botones y otros elementos bloque: */
        .text-center-xs {
        ...
        /* Centrar también los divs si quieres */
        .text-center-xs>.row_data>div {
            text-align: center !important;
        }
    }

@media (max-width: 767px) {
    .modal-dialog.modal_recogida {
        width: 95%;
        margin: 10px auto;
    }
