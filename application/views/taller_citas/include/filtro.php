<form method="post" action="" class="buscar_form form-horizontal" id="contactForm">
		...
		<?php $this->load->view('taller_citas/include/filtro_modal'); ?>
	<div class="row">

		<div class="col-sm-3 col-md-3">
			<label class="col-md-2 col-xs-12 control-label">Buscar</label>
			<div class="col-sm-8">
		...
		<div class="col-sm-3 col-md-3">
			...
			<div class="col-sm-8">
				<select class="form-control selectpicker" data-size="6" name="buscarCliente" id="buscarCliente" data-live-search="true">
		...
		<div class="col-sm-3 col-md-3">
			<label class="col-md-2 col-xs-12 control-label">Matricula</label>
			<div class="col-sm-8">
