<div class="row col-md-12 col-sm-12 box_datos hidden" id="filtro_modal" style="margin:10px"> 
    ...
    <?php if(isset($list_vehiculos) && $list_vehiculos!=0) : ?>
        ...
        <div class="col-sm-3 m-top-10">
            <label class="col-md-3 col-xs-12 control-label">F. Matriculación</label>
            <div class="col-sm-8">
        ...
        <div class="col-sm-3 m-top-10">
            <label class="col-md-3 col-xs-12 control-label">Fecha Mant. Basc.</label>
            <div class="col-sm-8">
        ...
        <div class="col-sm-3 m-top-10">
            <label class="col-md-3 col-xs-12 control-label">Fecha Mant. Compl.</label>
            <div class="col-sm-8">
        ...
        <div class="col-sm-3 m-top-10">
            <label class="col-md-3 col-xs-12 control-label">Tiene Cita</label>
    ...
    <?php elseif (isset($list_citas) && $list_citas!=0): ?>   
        ...
        <div class="col-sm-3 m-top-10">
            <label class="col-md-3 col-xs-12 control-label">Hora</label>
            <div class="col-sm-8">
        ...
        <div class="col-sm-3 m-top-10">
            <label class="col-md-3 col-xs-12 control-label">Tarea</label>
            <div class="col-sm-8">
                <select class="form-control selectpicker" data-size="6" name="buscarTarea" id="buscarTarea" data-live-search="true">
        ...
        <div class="col-sm-3 m-top-10">
            <label class="col-md-3 col-xs-12 control-label">Tiempo Estimado</label>
            <div class="col-sm-8">
        ...
        <div class="col-sm-3 m-top-10">
            ...
            <div class="col-sm-8">
                <select class="form-control selectpicker" data-size="6" name="buscarEstado" id="buscarEstado" data-live-search="true">
                    <option value="default" selected disabled>Seleccione un Estado</option>
                    <option value="">-- No seleccionar --</option>
                    <?php for ($i = 0; $i < count($optionsEstado); $i++) : ?>
                        <option value="<?= $optionsEstado[$i] ?>"><?= $optionsEstado[$i] ?></option>
                    <?php endfor; ?>
                </select>
            </div>
        </div> 
