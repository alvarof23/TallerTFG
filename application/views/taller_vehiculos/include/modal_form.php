<div class="modal fade" id="pruebaModal" tabindex="-1" role="dialog" aria-labelledby="editarClasLabel">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <!-- Columna Izquierda -->
                                <div class="col-md-6 col-sm-12 text-center" id="columna_izquierda">
                                    <div id="columna_izquierda_izquierda">
                                        <div class="form-group">
                                            <label class="col-md-2 control-label">Cliente</label>
                                            <div class="col-md-8">
                                                <select class="form-control select selectpicker" name="id_cliente" data-live-search="true" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <select class="form-control select selectpicker" id="marca" name="nom_marca" data-live-search="true" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <select class="form-control select selectpicker" name="id_modelo" id="modelo_change" data-live-search="true" required>
                                    ...
                                    <div id="columna_izquierda_derecha">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-2 control-label">Bastidor</label>
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" name="num_bastidor" required>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-md-2 control-label">Fabricado</label>
                                            <div class="col-md-8">
                                ...
                                <div class="col-md-6 text-center">
                                    ...
                                    <!-- Para subir imagenes -->
                                    <div class="form-group col-md-12" id="div_dropzone">
                                    ...
                                    <div class="table-container form-group"  style="margin-top: 10px;">
                        ...
                        <div class="modal-footer text-center">
                            ...
                            <button type="button" class="btn btn-default  pull-right  m-left-10 " data-dismiss="modal"><span class="fa fa-reply"></span> Volver</button>
                        </div>
