$(function() {
    ...
    var formElements = function(){                
        ...
        var feTimepicker = function(){
           ...
           $(document).delegate('.timepicker24Trigger','click',function(){ 
    ...
    var uiElements = function(){
        ...
        var uiDatatable = function(){
            if($(".datatable.codigos_postales").length > 0){                
                $(".datatable.codigos_postales").dataTable({"destroy":true,"info":false,"paging":true,"searching":true,"bLengthChange": false,"pageLength" : 15,"language": {
                    "paginate": {
                      "previous": "&lt","next":"&gt"
                    },"sSearch": "Buscar: "
                  }});
            ...
            else if($(".datatable.carrusel_productos_pagina").length > 0){                
                $(".datatable").dataTable({"destroy":true,"info":false,"paging":true,"searching":false,"bLengthChange": false,"pageLength": 15,"language": {
                    "paginate": {
                      "previous": "&lt","next":"&gt"
                    },"sSearch": "Buscar: ",
            ...
            else if($(".datatable.marketing").length > 0){                
                $(".datatable.marketing").dataTable({"destroy":true,"info":false,"paging":true,"searching":true,"bLengthChange": false,"language": {
                    "paginate": {
                      "previous": "&lt","next":"&gt"
                    },"sSearch": "Buscar: "
                  }});
            ...
            else if($(".datatable.productos").length > 0){                
                $(".datatable").dataTable({"destroy":true,"info":false,"paging":true,"pageLength": 25,"searching":false,"bLengthChange": false,"language": {
                    "paginate": {
                      "previous": "&lt","next":"&gt"
                    }
                  }});
            ...
            else if($(".datatable.modulos").length > 0){                
                $(".datatable").dataTable({"destroy":true,"info":false,"paging":true,"searching":true,"bLengthChange": false,"language": {
                    "paginate": {
                      "previous": "&lt","next":"&gt"
                    },"sSearch": "Buscar: "
                  }});
            ...
            else if($(".datatable.datatable-sin-ordenar").length > 0){                
                $(".datatable").dataTable({"destroy":true,"info":false,"paging":true,"pageLength":25,"searching":true,"bLengthChange": false,"ordering":false,"language": {
                    "paginate": {
                      "previous": "&lt","next":"&gt"
                    },"sSearch": "Buscar: "
                  }});
            ...
            // else if($(".datatable.list_orders").length > 0){                
            //     $(".datatable.list_orders").dataTable({order:[],"destroy":true,"info":false,"paging":true,"searching":false,"bLengthChange": false,"pageLength" : 10,"language": {
            //         "paginate": {
            //           "previous": "&lt","next":"&gt"
            //         },
            //       }});
            //     $(".datatable.list_orders").on('page.dt',function () {
            //         onresize(100);
            //     });
            // }
            else if($(".datatable.list_estadisticas").length > 0){                
                $(".datatable.list_estadisticas").dataTable({order:[],"destroy":true,"info":false,"paging":true,"searching":true,"bLengthChange": false,"pageLength" : 15,"language": {
                    "paginate": {
                      "previous": "&lt","next":"&gt"
                    },"sSearch": "Buscar: "
                  }});
                $(".datatable.list_estadisticas").on('page.dt',function () {
                    onresize(100);
                });
            }
            else if($(".datatable.list_workflow").length > 0){                
                $(".datatable.list_workflow").dataTable({order:[],"destroy":true,"info":false,"paging":true,"searching":false,"bLengthChange": false,"pageLength" : 20,"language": {
                    "paginate": {
                      "previous": "&lt","next":"&gt"
                    },"sSearch": "Buscar: "
                  }});
            ...
            else if($(".datatable.list_modal_clientes").length > 0){                
                $(".datatable").dataTable({"order": [[1,'asc']],"destroy":true,"info":false,"paging":true,"searching":true,"bLengthChange": false,"pageLength" : 15,"language": {
                    "paginate": {
                      "previous": "&lt","next":"&gt"
                    },"sSearch": "Buscar: "
                  }});
                ...
                $(".datatable").dataTable({"order": [[0, 'desc']],"destroy":true,"info":false,"paging":true,"searching":true,"bLengthChange": false,"pageLength" : 15,"language": {
                    "paginate": {
                      "previous": "&lt","next":"&gt"
                    },"sSearch": "Buscar: "
                  }});
