$(document).ready(function(){
    ...
    $(document).delegate(".faq .faq-item .faq-title",'click',function(){  
   ...
   // $("#faqForm").on("submit",function(){
    $(document).delegate("#faqForm",'submit',function(){  
    ...
    $(document).delegate("#faqOpenAll",'click',function(){    
        $(".faq .faq-item").addClass("active");
        onresize(300);
    });
    
    //$("#faqCloseAll").click(function(){
    $(document).delegate("#faqCloseAll",'click',function(){ 
        $(".faq .faq-item").removeClass("active");
        onresize(300);
    });
    
    //$("#faqRemoveHighlights").click(function(){
     $(document).delegate("#faqRemoveHighlights",'click',function(){ 
