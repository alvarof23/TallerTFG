...
// 
	...
	// AddColor : function() {
// 	
		// $('.colors').on('ifChecked', function() {
// 			
			// var id = $(this).attr('dir');
			// var value = $(this).val();
			// var text = 'El color ha sido añadido';
// 	
			 // var action = setTimeout(function() {
// 	
				// var type = 'POST';
				// var url = site_url + '/productos/update_color';
				// var data = {
					// 'value' : value,
					// 'id' : id
				// };
...
// 	
		// });
		// $('.colors').on('ifUnchecked', function() {
// 	
			// var id = $(this).attr('dir');
			// var value = $(this).val();
			// var text = 'El color ha sido eliminado';
// 	
			// var action = setTimeout(function() {
// 	
				// var type = 'POST';
...
// 	
		// /* TALLA */
		// $('.sizes').on('ifChecked', function() {
// 			
			// var id = $(this).attr('dir');
			// var value = $(this).val();
			// var text = 'Talla añadido.';
// 	
			// action = setTimeout(function() {
// 	
				// var type = 'POST';
				// var url = site_url + '/productos/update_size';
				// var data = {
					// 'value' : value,
					// 'id' : id
				// };
...
// 	
		// });
		// $('.sizes').on('ifUnchecked', function() {
// 	
			// var id = $(this).attr('dir');
			// var value = $(this).val();
			// var text = 'Talla eliminado.';
// 	
			// action = setTimeout(function() {
// 	
				// var type = 'POST';
...
$(window).load(ProductActions.ViewProduct);
...
// $(window).load(ProductActions.AddColor);
// $(window).load(ProductActions.AddSize);
